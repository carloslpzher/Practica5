...
function creaPagina(tipo) {
    ...
    //Añadimos un controlador de musica
    let musiquita = document.createElement("div");
    let iniciar = document.createElement("button");
    let pausar = document.createElement("button");

    iniciar.setAttribute("id", "btnInicio");
    pausar.setAttribute("id", "btnPausa");
    musiquita.setAttribute("id", "musicaContenedor");

    iniciar.innerHTML = "Iniciar";
    pausar.innerHTML = "Pausar";

    let sound = new Audio('./img/Sounds/cassTheme.mp3');
    ...
    musiquita.appendChild(iniciar);
    musiquita.appendChild(pausar);

    header.appendChild(musiquita);
